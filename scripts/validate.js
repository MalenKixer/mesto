...
const showInputError = (formElement, inputElement, errorMessage, inputErrorClass, errorClass) => {
   hasInputErrorElement(formElement, inputElement);
   hasInputErrorElement(formElement, inputElement).classList.add(errorClass);
   hasInputErrorElement(formElement, inputElement).textContent = errorMessage;
   inputElement.classList.add(inputErrorClass);
}

const hideInputError = (formElement, inputElement, inputErrorClass, errorClass) => {
   hasInputErrorElement(formElement, inputElement);
   hasInputErrorElement(formElement, inputElement).classList.remove(errorClass);
   hasInputErrorElement(formElement, inputElement).textContent = '';
