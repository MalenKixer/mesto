...
const popupImageValidator = createValidator(validationConfig, popupImage);
...
popupImage.addEventListener('submit', (evt) => {
   ...
   popupImageValidator.closePopupHandler();
});
...
addButton.addEventListener('click', () => {
      openPopup(popupRedactor);
      popupImageValidator.clearPopupInputs();
   }
);
...
popupImageValidator.enableValidation();